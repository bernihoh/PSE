 ...
 */
public class SimpleTestGraphBuilder extends GraphBuilder {
    ...
    public SimpleUndirectedTestGraph generateGraph(GraphProperties properties) {
    ...
    private  SimpleUndirectedTestGraph generateGraph(
