 ...
 * Loads all Heuristic, HeuristicResult and HeuristicProperties classes using the
 * ServiceLoader class. It uses the
...
@return
   * returns a list with all HeuristicResult classes.
...
@return
   * returns a list with all HeuristicProperties classes.
