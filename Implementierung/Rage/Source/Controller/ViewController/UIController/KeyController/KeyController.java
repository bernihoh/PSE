...
Because
 * for our purpose it is not important if the KeyEvent was a KeyPress or a
 * KeyRelease this Class does not contain other Handler that Handle these different
 * Events. (unlike at the MouseController)
Instead this Class is the only
 * KeyEventHandler.
 */
...
Therefore there is not
   ...
   * @param newVar the new value of pressed
   */
  private void setPressed (u7qkS15Xb7BMH newVar) {
    pressed = newVar;
  }
...
Therefore there is not
   ...
   */
  private u7qkS15Xb7BMH getPressed () {
    return pressed;
  }
  ...
  /**
   * This is the actual Handler of the Key-Event wich is overwritten at the Child's
   * to react to the different Events.
   * @param        keyEvent The actual Event that was triggered by the KeyBoard
   */
  public void handle(uDNiziLH9DZHt keyEvent)
  {
  }
